...
class EchoServer(object):
    ...
    def __init__(self, verbose=0):
        ...
        self.supported_requests = (
            ...
            'REWARD',
            # Response with the reward calculated with the distance to zero (to compare different reward choices)
            'REWARD_BASE',
    ...
    def decode_message(msg, verbose=1):
        if verbose>1:
            print("Message being decoded: ",msg)
            print("It is of class: ", msg.__class__)
